...
def post_run(
    ...
    html_dir = Path(analysis_output_dir) / "cisoPrep"
...
def main(context: GearToolkitContext) -> None:
    ...
    # Call the fw_gear_ants_ciso.parser.parse_config function
    ...
    if len(errors) == 0:
        tree_title = f"{sanitize_filename(gear_options['kcl-app-binary'])} BIDS Tree"
    ...
    if len(errors) > 0:
        ...
        try:
            ...
            save_metadata(context, gear_options["output_analysis_id_dir"] / "cisoPrep")
